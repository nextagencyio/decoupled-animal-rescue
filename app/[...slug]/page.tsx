  ...
  return (
    <div className="text-center py-16">
      <div className="bg-white rounded-2xl shadow-md shadow-primary-200/50 p-12">
        <h1 className="text-2xl font-semibold text-gray-900 mb-4 font-display">Page Not Found</h1>
          ...
          <ErrorBoundary>
            <article className="bg-white rounded-2xl shadow-md shadow-primary-200/50 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6 font-display">{title}</h1>

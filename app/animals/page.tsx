...
import { AnimalsData } from '@/lib/types'
...
export const metadata: Metadata = {
  title: 'Animals | Safe Paws Rescue',
  description: 'Browse our animals.',
}
...
async function getAnimals() {
  try {
    ...
    const { data } = await apolloClient.query<AnimalsData>({
      query: GET_ANIMALS,
      variables: { first: 50 },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-semibold text-gray-600 mb-2">No Animals Yet</h2>
              <p className="text-gray-500">
                Animals will appear here once content is imported.
              </p>
            </div>
          ) : (

...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Second Chance Animal Rescue. We\'d love to hear from you about adopting, volunteering, or donating.',
  keywords: ['Contact Second Chance Animal Rescue', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about adopting, volunteering, or donating? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@secondchancerescue.org</p>
                    <p className="text-gray-600">support@secondchancerescue.org</p>
                  </div>
                </div>

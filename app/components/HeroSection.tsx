...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  const title = (homepageContent as any)?.heroTitle || (homepageContent as any)?.title || 'Welcome to Safe Paws Rescue'
  const subtitle = (homepageContent as any)?.heroSubtitle || 'Every Animal Deserves a Loving Home'
  ...
  return (
    <section className="relative bg-primary-600 overflow-hidden pt-32 pb-24">
      ...
      <div
        ...
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=1920&q=80&fit=crop)' }}
      />

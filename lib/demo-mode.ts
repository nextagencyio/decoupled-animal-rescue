...
import animalsData from '@/data/mock/animals.json'
import eventsData from '@/data/mock/events.json'
import volunteerOpportunitiesData from '@/data/mock/volunteer.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'volunteer.json': volunteerOpportunitiesData,
  'news.json': newsData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetAnimals') || query.includes('nodeAnimals')) {
      return loadMockData('animals.json')
    }
    ...
    if (query.includes('GetVolunteerOpportunities') || query.includes('nodeVolunteerOpportunities')) {
      return loadMockData('volunteer.json')
    }
